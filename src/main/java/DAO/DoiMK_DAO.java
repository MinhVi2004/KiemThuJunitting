...
public class DoiMK_DAO {
    ...
    public String changePassword3(String username, String oldPassword, String newPassword) {
        ...
        try (Connection conn = mySQL.getConnection();
            ...
            if (rs.next()) {
                ...
                if (!currentPassword.equals(oldPassword)) {
                    ...
                    return "Mật khẩu cũ không đúng cho username";
                }
            } else {
            ...
            return (rowsAffected > 0)?"Đổi mật khẩu thành công":"Đổi mật khẩu thất bại";
        } catch (SQLException e) {
            LOGGER.log(Level.SEVERE, "Lỗi trong phương thức changePassword của DoiMK_DAO", e);
            return "Lỗi trong phương thức changePassword của DoiMK_DAO";
        }
    }
