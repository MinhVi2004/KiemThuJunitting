...
public class ChiTietDiemDTO {
    ...
    public ChiTietDiemDTO(String hocSinhID, String monHocID, String hocKyID, String namHocID, Double diem1,
            Double diem2, Double diem3) {
    ...
    // this.dtbMon = Double.parseDouble(df.format((this.Diem1*1 + this.Diem2*2 +
    // this.Diem3*3) / 6));
    // }
    public void calDtbMon() {
